  ...
  return (
    <section id="about" className="py-20 px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="animate-float-smooth mb-16 bg-gradient-to-br from-purple-900/30 to-pink-900/30 backdrop-blur-sm border border-purple-500/30 rounded-3xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="animate-card bg-black/30 rounded-2xl p-6 border border-yellow-500/30">
              <div className="text-white text-xl mb-2">First Prize</div>
              <div className="text-yellow-400 text-3xl">₹4,000/-</div>
            </div>
            <div className="animate-card bg-black/30 rounded-2xl p-6 border border-gray-400/30">
              <div className="text-white text-xl mb-2">Second Prize</div>
              <div className="text-gray-300 text-3xl">₹2,000/-</div>
            </div>
            <div className="animate-card bg-black/30 rounded-2xl p-6 border border-cyan-500/30">
        ...
        <div className="mb-16">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            <div className="animate-card flex items-start gap-3 text-white bg-black/30 p-4 rounded-xl border border-purple-500/20">
        ...
        <div>
          ...
          <div className="max-w-md mx-auto animate-float-delay-1">
            <div className="animate-card bg-gradient-to-br from-pink-900/30 to-purple-900/30 backdrop-blur-sm border border-pink-500/20 rounded-2xl p-6 hover:border-pink-500/50 transition-all cursor-pointer">
